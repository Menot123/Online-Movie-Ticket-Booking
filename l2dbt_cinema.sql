...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 21, 2023 lúc 03:52 PM
...
(1, 'Siêu Lừa Gặp Siêu Lầy: Phi Vụ Hoàn Hảo Của Điện Ảnh', 'Siêu Lừa Gặp Siêu Lầy là một cuốn phim tốt về mọi mặt, nếu mong muốn có những giây phút giải trí thư giãn', '/img/rv1.jpg', 3107, 8, 'binhluan', 'Một kẻ lừa lọc ranh mãnh theo kiểu “cây nhà lá vườn”, một người thì lừa đảo bằng việc lên kế hoạch tỉ mỉ chỉn chu để dụ con mồi vào bẫy. Một bên thì vì mưu sinh nên dẫn đến tham lam, bên còn lại thì lấy danh nghĩa thực thi công lấy lừa xấu giúp tốt. Thử hỏi nếu cả 2 cùng hợp tác trong các phi vụ thì liệu có thành công thu được chiến lợi phẩm rực rỡ?', 'Những gì mà Siêu Lừa Gặp Siêu Lầy đem tới không đơn thuần là những tràng cười sảng khoái, mà còn có sự cao thấp hơn thua khi các bộ não hoạt động tối đa công suất. Từ đây nhóm siêu lừa với mỗi thành viên đều có biệt tài riêng bắt đầu con đường chinh chiến. Sau khi chứng kiến “đẳng cấp” của Tú và đồng bọn thì Khoa tìm cách để xin nhập hội. Đi cùng đấy vẫn có khoảnh khắc lắng đọng về thân phận, cuộc đời và nỗi niềm của từng người. Sau khi “lỡ hẹn” với khán giả vào dịp Tết Nguyên Đán, giờ đây phim mới nhất của đạo diễn Võ Thanh Hòa tiếp tục chứng minh tài năng của nhà làm phim dày dặn kinh nghiệm này với thể loại sở trường: hành động pha hài hước. Dẫn đến thông điệp cuối cùng là tình đồng đội, tình bạn bè, sẵn sàng xả thân bên nhau lúc hoạn nạn và cùng chia niềm vui hạnh phúc nhất. Sau nhiều lần “phạm tội” thành công, cả nhóm tiếp cận một “người bị hại” trông có vẻ đầy tiềm năng, mục đích là gom trọn vố lớn để sống thoải mái về sau. Phim kể về sự đụng độ bất đắc dĩ giữa Tú (Anh Tú) và Khoa (Mạc Văn Khoa), hai người đều kiếm sống bằng nghề lừa gạt. Ngoại trừ Tú và Khoa làm lãnh đạo thì còn có bé Mã Lai (Ngọc Phước) – một chuyên gia công nghệ đầy bản lĩnh. Còn lại là chú Năm (Trung Lùn) – “người vận chuyển” với biệt tài lái xe siêu hạng.', 'Tất cả những vụ làm ăn trót lọt của nhóm đều tập trung vào các đối tượng thực tế hơn. Thì ra cả Tú, Khoa, bé Mã Lai và chú Năm đều là những mảnh đời đáng thương. Không sa đà vào mưu mô cao siêu khi cố thâm nhập vào giới thượng lưu hào nhoáng, cũng không bám víu vào công nghệ tiên tiến. Cốt truyện của phim không hẳn là xa lạ khi đã từng có nhiều tác phẩm trước đây cũng khai thác đề tài này, nhưng Võ Thanh Hòa đã khéo léo khi xây dựng được bản sắc riêng cho đứa con tinh thần của mình. Tuy các trận “giáp lá cà” không nhiều nhưng mỗi cảnh đều được chăm chút kỹ càng. Đấy có thể là các quý bà lắm của nhưng thiếu tình, những đại gia đầy tiền sẵn sàng chi trội để mua khoảnh khắc vui vẻ. Đã có vui vẻ thì đồng thời cũng có khoảng lặng. Khi tất cả mở lòng với những nỗi đau từng trải qua, các khúc mắc được gỡ bỏ sẽ giúp cho việc đồng cảm với tâm lý nhân vật trở thành điều dễ dàng. Phân đoạn khi các nhân vật chia sẻ về hoàn cảnh cá nhân thực sự gây xúc động. Hoặc đôi khi chỉ là dạng vô tình chạm mặt, thấy bở nên cứ tiện tay mà đào! Vì có pha yếu tố hành động nên phim không thiếu những màn rượt đuổi gây cấn. Trong họ ai cũng có quá khứ đau lòng, nỗi buồn chất chứa nhiều đến mức không còn gì có thể đánh gục ý chí của những người này.', 'Bên cạnh đó, phim còn quy tụ hàng sao “khủng” trong vai trò cameo như Đại Nghĩa, BB Trần, Mỹ Duyên, Lâm Vỹ Dạ, Hứa Minh Đạt…, mỗi người tuy xuất hiện ít nhưng lại có phần trình diễn chất lượng cao. \r\nCó thể nói Siêu Lừa Gặp Siêu Lầy là một cuốn phim tốt về mọi mặt. Từ kịch bản, tạo hình, diễn xuất, âm nhạc… Nếu mong muốn có những giây phút giải trí thư giãn sau nhiều giờ làm việc căng thẳng thì đây sẽ là lựa chọn hoàn hảo. \r\nPhim đang chiếu tại các hệ thống rạp trên toàn quốc. ', '/img/chitietsieulua1.jpg', '/img/chitietsieulua2.jpg', '/img/chitietsieulua3.jpg', '/img/sieulua.jpg'),
(2, 'Ant-Man And The Wasp Quantumania: Cú Lừa Xuất Sắc', 'Ai nghĩ rằng trailer Ant-Man And The Wasp: Quantumania đã tóm tắt bộ phim thì lầm to rồi.', './img/rv2.jpg', 8113, 9, 'binhluan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(4, 'Chị Chị Em Em 2: Ngọc Trinh Hoàn Hảo, Minh Hằng', 'Đạo diễn Vũ Ngọc Đãng thành công vừa làm nổi bật Ngọc Trinh bốc lửa vừa tôn được nét đẹp đằm thắm của Minh Hằng.', './img/rv4.jpg', 10023, 9, 'binhluan', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
